var verifs = ["validsus1", "ThisCookiiee", "Dezaku", "Urban", "Reggrysterm", "OOOPS", "ValidUser", "nemesis_chainyy", "gnnr", "PalmerK2147F"]
...
const callback = function(mutations, observer) {
    ...
    var table = Array.from(tableChildren.children, el => {
        ...
        if (name in window.verified) {
            ...
            image.src = "files/assets/32335389/1/Verified-Icon-valid.png";
